...
class MainWindow(QMainWindow):
    ...
    def processData(self):
        ...
        self.this_session_data.pdf_charts_filenames = set()
    ...
    def getCurrentChart(self):
        if self.checkBox.isChecked():
            # if self.this_session_data.update_current_chart_path not in self.this_session_data.pdf_charts_filenames: 
            self.this_session_data.pdf_charts_filenames.add(self.this_session_data.update_current_chart_path)
